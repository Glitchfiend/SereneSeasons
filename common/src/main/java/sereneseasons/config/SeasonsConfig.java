...
public class SeasonsConfig extends glitchcore.config.Config
{
    ...
    private static final Map<Season.SubSeason, SeasonProperties> DEFAULT_SEASON_PROPERTIES = Lists.newArrayList(
            ...
            new SeasonProperties(Season.SubSeason.EARLY_SPRING, 6.25F, 1, -0.25F, 12000, 96000, THUNDER_DELAY.minInclusive(), THUNDER_DELAY.maxInclusive()),
            new SeasonProperties(Season.SubSeason.MID_SPRING, 8.33F, 1, 0.0F, 12000, 96000, THUNDER_DELAY.minInclusive(), THUNDER_DELAY.maxInclusive()),
            new SeasonProperties(Season.SubSeason.LATE_SPRING, 12.5F, 1, 0.0F, 12000, 96000, THUNDER_DELAY.minInclusive(), THUNDER_DELAY.maxInclusive()),
            new SeasonProperties(Season.SubSeason.EARLY_SUMMER, 25.0F, 1, 0.0F, 12000, 96000, THUNDER_DELAY.minInclusive(), THUNDER_DELAY.maxInclusive()),
            new SeasonProperties(Season.SubSeason.MID_SUMMER, 25.0F, 1, 0.0F, 12000, 96000, THUNDER_DELAY.minInclusive(), THUNDER_DELAY.maxInclusive()),
            new SeasonProperties(Season.SubSeason.LATE_SUMMER, 25.0F, 1, 0.0F, 12000, 96000, THUNDER_DELAY.minInclusive(), THUNDER_DELAY.maxInclusive()),
            new SeasonProperties(Season.SubSeason.EARLY_AUTUMN, 12.5F, 1, 0.0F, RAIN_DELAY.minInclusive(), RAIN_DELAY.maxInclusive(), THUNDER_DELAY.minInclusive(), THUNDER_DELAY.maxInclusive()),
            new SeasonProperties(Season.SubSeason.MID_AUTUMN, 8.33F, 1, 0.0F, RAIN_DELAY.minInclusive(), RAIN_DELAY.maxInclusive(), THUNDER_DELAY.minInclusive(), THUNDER_DELAY.maxInclusive()),
            new SeasonProperties(Season.SubSeason.LATE_AUTUMN, 6.25F, 1, -0.25F, RAIN_DELAY.minInclusive(), RAIN_DELAY.maxInclusive(), THUNDER_DELAY.minInclusive(), THUNDER_DELAY.maxInclusive())
