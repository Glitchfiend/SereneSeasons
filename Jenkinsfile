    ...
    stages {
        ...
        stage('publish') {
            ...
            steps {
                ...
                sh 'curl --user ${FORGE_MAVEN_USR}:${FORGE_MAVEN_PSW} http://files.minecraftforge.net/maven/manage/promote/latest/com.github.glitchfiend.biomesoplenty.SereneSeasons/${MYVERSION}'
            }
        }
    }
    post {
