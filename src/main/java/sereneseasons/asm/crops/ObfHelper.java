...
public class ObfHelper
{
    ...
    /**
     * Can be initialized by a core mod in
     * {@link cpw.mods.fml.relauncher.IFMLLoadingPlugin#injectData} by using the
     * value of "runtimeDeobfuscationEnabled" to avoid the class loader lookup in
     * isObfuscated.<br>
     * <br>
     * <b>Example:</b>
     * 
    ...
    /**
     * @return Whether or not the current environment contains obfuscated Minecraft
     *         code
     */
    ...
    /**
     * Converts a class name to an internal class name, obfuscating the class name
     * if {@link #isObfuscated()}.
     * 
    ...
    /**
     * Converts a class name to a descriptor, obfuscating the class name if
     * {@link #isObfuscated()}.
     * 
