...
public class SeasonsConfig
{
    ...
    static
    {
        ...
        startingSubSeason = BUILDER.comment("The starting sub season for new worlds.  0 = Random, 1 - 3 = Early/Mid/Late Spring, 4 - 6 = Early/Mid/Late Summer, 7 - 9 = Early/Mid/Late Autumn, 10 - 12 = Early/Mid/Late Winter").defineInRange("starting_sub_season", 1, 0, 12);
